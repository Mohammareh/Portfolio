...
const CheckMyProjects = () => {
  ...
  const text = "Check these shi*ty projects then";
    ...
    <section ref={firstTargetRef} className="relative h-[300vh]">
      <div className="sticky top-0 flex h-screen items-center overflow-hidden w-screen justify-center">
        <motion.div className="flex text-center">
          <p
            className="text-xl sm:text-6xl md:text-[5rem] lg:text-[6rem] xl:text-[7rem] 2xl:text-[9rem] text-center font-bold flex flex-wrap justify-center space-x-4 space-y-8"
            style={{}}
          >
            {letters.map((char, i) => (
              <Character
...
export default CheckMyProjects;
